# Receipt Image Upload — Spec

## Purpose

Permettre à l'utilisateur d'uploader une photo de son reçu fournisseur (jpg, png, webp) en plus du texte brut, pour que l'IA multimodale puisse extraire les articles directement depuis l'image.

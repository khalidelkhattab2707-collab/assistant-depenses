...
## Purpose
Allow authenticated users to create, view, edit, and delete individual expenses linked to their receipts. Full CRUD is exposed via RESTful resource routes under `/depenses`.
